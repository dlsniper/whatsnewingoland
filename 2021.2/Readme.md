...
[![What's New in GoLand 2021.2](https://img.youtube.com/vi/3krpWjdisGo/0.jpg)](https://www.youtube.com/watch?v=3krpWjdisGo "What's New in GoLand 2021.2")
...
### Browser pages reload on save
  ...
  07. The IDE can automatically reload the page opened in a browser after you make changes to an HTML file or the linked CSS and JavaScript files. Reloading is triggered whenever changes are saved in the IDE, either automatically or using Ctrl + S on Windows/Linux or Cmd + S on macOS, or when changes are made to a file externally.
...
### Run custom Tests before commit
  ...
  **Note:** You must have the `Use non-modal commit interface` activated before you can use this feature. Check under your settings at `Settings/Preferences | Version Control | Commit`.
...
### Run custom Inspections before commit
  ...
  17. Committing error-free code is important. Since not all errors are caught by inspections, you can also choose to
  run Inspections before commit. This will improve your chances to have fewer bugs in code.
...
### Accessibility
  ...
  A list of code completion options will be read out loud on macOS. The content of the selected combo box and combo box lists has been added too.
